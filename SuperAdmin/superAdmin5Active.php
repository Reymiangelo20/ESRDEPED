...
<head>
  ...
  <title>Super Admin | Active Employees</title>
</head>
...
<input type="checkbox" id="check">
  ...
  <div class="heads">
    <div class="title-page-div">
      <p class="page-title">Active Employees</p>
      <!-- Administrators -->
    </div>
  ...
  <div class="side-bar-div">
    ...
    <div class="side-bar-options-div">
      ...
      <div class="active-employee-option-div" style="background-color: rgb(49, 104, 255);">
  ...
  <!-- table starts here -->
        <?php
          $sql = "SELECT * FROM emppersonalinfo WHERE teacher_status = 'Active' ORDER BY id DESC;";
